...
Route::get('/dashboard/gallery', 'DashboardController@gallery')->name('gallery');
Route::get('/dashboard/subscribers', 'DashboardController@subscribers')->name('Subscribers');
Route::get('/dashboard/treatmenttypes', 'DashboardController@treatmenttypes')->name('Treatmenttypes');
...
Route::resource('treatments', 'TreatmentTypeController');
